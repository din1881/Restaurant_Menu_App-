...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     " been prepared since the imperial era. The meat is"
                     " prized for its thin, crisp skin, with authentic version"
                     " of the dish serving mostly the skin"
                     " and little meat, sliced in front of the"
                     " diners by the cook", price="$25", course="Entree",
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup", 
                     ...
                     " braised beef, beef broth, vegetables and Chinese.",
...
menuItem6 = MenuItem(user_id=1, name="Ramen", 
                     ...
                     " Chinese-style wheat noodles served in a meat- "
                     "or (occasionally) fish-based broth, often flavored "
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake", 
                     ...
                     " in sweet milk and topped with vanilla bean whipped"
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     ...
                     " and freshly made mochi", price="$4.50", 
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian", 
                     ...
                     " in a midly spiced soya,garlic sauce cooked with fresh"
...
menuItem2 = MenuItem(user_id=1, name="Veggie Burger", 
                     description="Juicy grilled veggie with mayo and lettuce",
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", 
                     ...
                     " with a spicy mix(chilli, tamarind among others) andslow"
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast", description="Crispy"
                     "Toast with Sesame Seeds slatherd with buttery chantrelle"
                     "mushrooms",
